  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        <div className="rounded-3xl border border-slate-800/50 bg-slate-950/90 backdrop-blur-xl shadow-2xl p-8">
          {/* Header */}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full rounded-xl border border-slate-700 bg-slate-900 px-4 py-3 text-sm text-slate-50"
                />
